...
lib.mkIf pkgs.stdenv.isLinux {
  programs.plasma = {
    ...
    configFile = {
      ...
      kwinrc.Desktops.Id_1 = "6ad73845-dd0d-4f7f-8819-394149f99a1e";
      ...
      kwinrc."Tiling/c59323a7-6c7c-5999-ba78-4b8c03a908f2".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
